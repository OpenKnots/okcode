...
Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.26.2`](https://github.com/OpenKnots/okcode/releases/tag/v0.26.2) by the [Release workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.26.2.md](../v0.26.2.md)           |
