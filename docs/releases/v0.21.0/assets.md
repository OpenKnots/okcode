# v0.21.0 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.21.0`](https://github.com/OpenKnots/okcode/releases/tag/v0.21.0) by the [coordinated release workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.21.0.md](../v0.21.0.md)           |
| `okcode-ASSETS-MANIFEST.md` | This file                             |

After the workflow completes, the release should contain the coordinated desktop outputs below. Filenames may include the product name `OK Code` and the version string `0.21.0`.
