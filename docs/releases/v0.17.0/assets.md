# v0.17.0 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.17.0`](https://github.com/OpenKnots/okcode/releases/tag/v0.17.0) by the [Release Desktop workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.17.0.md](../v0.17.0.md)           |
