# v0.23.3 Soak Test Plan

Structured validation plan for the highest-risk surfaces in v0.23.3.
...
| Verify a packaged desktop artifact launches and reports the new version | Installed app opens cleanly and reports v0.23.3        | [ ]  |
