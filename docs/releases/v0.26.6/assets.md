# v0.26.6 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.26.6`](https://github.com/OpenKnots/okcode/releases/tag/v0.26.6) by the [Release workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.26.6.md](../v0.26.6.md)           |
| `okcode-ASSETS-MANIFEST.md` | This file                             |

After the workflow completes, expect **installer and updater** artifacts similar to the following (exact names may include the product name `OK Code` and version `0.26.6`).
