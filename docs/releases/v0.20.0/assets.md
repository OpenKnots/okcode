# v0.20.0 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.20.0`](https://github.com/OpenKnots/okcode/releases/tag/v0.20.0) by the [Release Desktop workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.20.0.md](../v0.20.0.md)           |
| `okcode-ASSETS-MANIFEST.md` | This file                             |

After the workflow completes, expect **installer and updater** artifacts similar to the following (exact names may include the product name `OK Code` and version `0.20.0`).
