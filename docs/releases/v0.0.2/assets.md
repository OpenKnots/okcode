# v0.0.2 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.0.2`](https://github.com/OpenKnots/okcode/releases/tag/v0.0.2) by the [Release Desktop workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.0.2.md](../v0.0.2.md)             |
| `okcode-ASSETS-MANIFEST.md` | This file                             |

After the workflow completes, expect **installer and updater** artifacts similar to the following (exact names may include the product name `OK Code` and version `0.0.2`).
